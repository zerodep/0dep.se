...
src/runner/          browser runners: bpmn-runner.js (engine wiring), bpmn-app.js (/run/ page UI, esbuild entry),
                     ...
                     tools-lib.js (piso/ocrgenerator evaluation + localStorage history), tools-app.js (/tools/ page UI, esbuild entry)
